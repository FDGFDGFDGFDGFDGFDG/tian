 ...
 */
 function typewrite()
 {
     let str="<那我就希望你能记住我这个阶段性的朋友吧 来路方长 <祝你努力生活 天天开心 保持热爱 奔赴山海 <我们有缘自会相遇 无缘就留一段可爱的回忆吧！<笨蛋强子哥";//利用<作为换行符 -作为空格
     let strp="";
     let i=0;
     function print1()
     {
...
let clickb=false;//判断播放按钮是否已经按过了，如果已经按过了才可以执行键盘事件
 ...
 let a=[
     ...
     {name:"H" ,yin:5, str:"<br><br>你的双眸有遥远的冬雪，你的微笑有绚烂的夏阳，<br></br>你一转身便有花开你，你一低头便有星辰黯然，<br></br>你在我心里，我便拥有全世界。"},
